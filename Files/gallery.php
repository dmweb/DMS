<?php
include_once('blog/resources/midd.php');
...
?></li>
												...
												<li><a href="gallery.php"><div class="nav-active">Gallery</div></a></li>
			...
			<section class="page-subheader-lol"><h1>Gallery</h1></section>
	...
	<section id="main_content_container">
	  ...
	  <?php
     foreach($posts as $post)if ($tmp++ < 12){
      ?>
		
             <img src="blog/images/<?php echo $post['image']; ?>"/>
